                  ...
                  <VListItem>
                    ...
                    <template v-slot:append>
                      <v-avatar size="60" color="secondary">
                        <v-icon class="shadow" color="white-primary" size="30"
                          >mdi-timer-plus</v-icon
                        >
                      </v-avatar>
                    </template>
                  </VListItem>
              ...
              <VCard class="mt-8 mx-auto overflow-visible" elevation="6">
                ...
                <v-card-text class="pt-0">
                  ...
                  <span class="text-caption text-grey font-weight-light"
                    >last assestment 26 minutes ago</span
                  >
                </v-card-text>
              </VCard>
            </VCol>
...
const value = ref([200, 675, 410, 390, 310, 460, 250, 240, 310, 460, 900, 100]);
</script>
